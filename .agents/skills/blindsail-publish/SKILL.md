...
## Stage 3 — Screen (Codex, inline — the judgment gate)
...
## Stage 4 — Write captions / alt / AD (Codex, inline)
...
## Stage 7 — Highlight reel (Codex drafts, Remotion renders, ffmpeg muxes)
